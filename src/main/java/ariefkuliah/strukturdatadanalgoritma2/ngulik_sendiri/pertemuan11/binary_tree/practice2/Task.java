package ariefkuliah.strukturdatadanalgoritma2.ngulik_sendiri.pertemuan11.binary_tree.practice2;
...
public class Task {
    ...
    public static void main(String[] args) {
         ...
         * Insert Data.
         * */
        Node nodeA = task.createNewTree('A');
        ...
        Node nodeK = task.insertRight('K', nodeF);
        Node nodeL = task.insertLeft('L', nodeF);
        ...
        /**
         * Find Node and its root, parent, sibling and childs.
         * */
        task.findNode(nodeE);
        task.findNode(nodeK);
        task.findNode(nodeB);
        ...
        System.out.println("Node A");
        task.postOrder(nodeA);
        System.out.println("\n");
        System.out.println("Node B");
        task.postOrder(nodeB);
        System.out.println("\n");
        System.out.println("Node E");
        task.postOrder(nodeE);
        System.out.println("\n");

        System.out.println("Delete");
        System.out.println("Sebelum di delete.");
        task.characteristic();
        task.preOrder(nodeA);
        System.out.println();

        System.out.println("\n" + "Operasi Delete");
        task.deleteSub(nodeE);
        System.out.println("Setelah di delete.");
        System.out.println("Size Tree: " + task.size(task.root));
        System.out.println();
        task.characteristic();
        ...
        System.out.println("Height tree : " + task.height(nodeA));
    }
}